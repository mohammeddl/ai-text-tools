...
var qrcode = (function () {
    var qrcode = function (typeNumber, errorCorrectLevel) {
        ...
        var _makeImpl = function (test, maskPattern) {
        ...
        var _setupPositionProbePattern = function (row, col) {
            for (var r = -1; r <= 7; r++) {
        ...
        var _getBestMaskPattern = function () {
            var minLostPoint = 0;
            var pattern = 0;
            for (var i = 0; i < 8; i++) {
                _makeImpl(true, i);
        ...
        var _createData = function (typeNumber, errorCorrectLevel, dataList) {
        ...
        var _createBytes = function (buffer, rsBlocks) {
            var offset = 0;
            var maxDcCount = 0;
            var maxEcCount = 0;
        ...
        var _setupTypeInfo = function (test, maskPattern) {
        ...
        var _setupTypeNumber = function (test) {
        ...
        var _setupPositionAdjustPattern = function () {
        ...
        var _setupTimingPattern = function () {
        ...
        var _mapData = function (data, maskPattern) {
            var inc = -1;
    ...
    qrcode.prototype.createDataURL = function (cellSize, margin) {
        ...
        var xml = '<svg xmlns="http://www.w3.org/2000/svg" width="' + size + '" height="' + size + '" viewBox="0 0 ' + size + ' ' + size + '">';
        xml += '<rect width="100%" height="100%" fill="#ffffff" />';
        xml += '<path d="';
        for (var r = 0; r < mods; r++) {
            for (var c = 0; c < mods; c++) {
                if (this.isDark(r, c)) {
                    ...
                    xml += 'M' + x + ',' + y + 'h' + cellSize + 'v' + cellSize + 'H' + x + 'V' + y + 'z ';
                }
            }
        }
        xml += '" fill="#000000" />';
        xml += '</svg>';
        return createDataURL(xml);
    };
