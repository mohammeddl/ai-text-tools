        ...
        <div className="container">
          ...
          <div className="contact-socials">
            <Copy delay={1.7} animateOnScroll={false}>
              <a
                className="sm"
                href="https://www.instagram.com/mohammed_dl1"
                target="_blank"
              >
                Instagram
              </a>
            ...
            <Copy delay={1.8} animateOnScroll={false}>
              <a
                className="sm"
                href="https://www.linkedin.com/in/daali-mohammed-85736b271"
                target="_blank"
              >
                LinkedIn
              </a>
          ...
          <Copy delay={2} animateOnScroll={false}>
            <p className="sm">&copy; daali mohammed</p>
          </Copy>
        </div>
      </div>
    </section>
